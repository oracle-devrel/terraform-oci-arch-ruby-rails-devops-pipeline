...
variable "build_pipeline_description" {
  default = "build pipeline for Ruby application"
}

variable "build_pipeline_display_name" {
  default = "Ruby-build-pipeline"
}
...
variable "repository_description" {
  default = "Ruby sample application"
}

variable "git_repo" {
  default = "https://github.com/chiphwang1/oci-devops-node.git"
}
